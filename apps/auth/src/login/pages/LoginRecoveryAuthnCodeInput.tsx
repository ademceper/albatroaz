...
export default function LoginRecoveryAuthnCodeInput(
    ...
    return (
        ...
        >
            <form id="kc-recovery-code-login-form" action={url.loginAction} method="post" className="space-y-4">
                <div className="space-y-1.5">
                    ...
                    />
                    <FieldError messagesPerField={messagesPerField} fieldName="recoveryCodeInput" />
                </div>
