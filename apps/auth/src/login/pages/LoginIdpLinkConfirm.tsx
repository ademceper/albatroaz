    ...
    return (
        ...
        >
            <form id="kc-register-form" action={url.loginAction} method="post" className="space-y-4">
                <Button type="submit" size="lg" className="w-full" name="submitAction" value="updateProfile" id="updateProfile">
                    {msgStr("confirmLinkIdpReviewProfile")}
                </Button>
                <Button type="submit" variant="outline" size="lg" className="w-full" name="submitAction" value="linkAccount" id="linkAccount">
